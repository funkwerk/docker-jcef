...
RUN mkdir -p jcef \
    ...
    && make -j4 \
    && ln -s /jcef/src/third_party/cef/cef_binary_3.2785.1482.g16e49fb_linux64/Resources/icudtl.dat /usr/lib/jvm/java-8-oracle/bin/icudtl.dat \
    && ln -s /jcef/src/third_party/cef/cef_binary_3.2785.1482.g16e49fb_linux64/Debug/natives_blob.bin /usr/lib/jvm/java-8-oracle/bin/natives_blob.bin \
    && ln -s /jcef/src/third_party/cef/cef_binary_3.2785.1482.g16e49fb_linux64/Debug/snapshot_blob.bin /usr/lib/jvm/java-8-oracle/bin/snapshot_blob.bin \
    && cd ../tools \
    && ./compile.sh linux64
